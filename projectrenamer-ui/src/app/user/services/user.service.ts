...
export class UserService {
    ...
    public GetUser(): Observable<GetUserResponse> {
        return this.httpClient.get<GetUserResponse>(environment.DotNetTemplateUrl + '/users/me');
    }
    ...
    public GetUserRoles(): Observable<GetUserRolesResponse> {
        return this.httpClient.get<GetUserRolesResponse>(environment.DotNetTemplateUrl + '/users/me/roles');
    }
}
